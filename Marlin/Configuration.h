...
#define STRING_CONFIG_H_AUTHOR "(odaki)" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_KINGROON_KP3_V1_3
#endif
...
#define CUSTOM_MACHINE_NAME "Fraxinus"
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_KP_LIST { 19.475, 19.475 }
    #define DEFAULT_KI_LIST {  1.583,  1.583 }
    #define DEFAULT_KD_LIST { 59.885, 59.885 }
  #else
    #define DEFAULT_KP  19.475
    #define DEFAULT_KI   1.583
    #define DEFAULT_KD  59.885
  #endif
#else
...
#define PIDTEMPBED
  ...
  #define DEFAULT_BED_KP 73.109
  #define DEFAULT_BED_KI 2.278
  #define DEFAULT_BED_KD 586.697
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 250, 250, 25, 75 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 7700, 7700, 100, 1500 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -25.0, 5, -2.130 }
